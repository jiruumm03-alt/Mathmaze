...
session_start();
if (!isset($_SESSION['username'])) {  // <-- changed from 'teacher' to 'username'
...
$teacher = htmlspecialchars($_SESSION['username']); // <-- match session variable name
...
<body>
  ...
  <header>
    ...
    <div class="header-right">
      <span>Welcome, <strong><?= $teacher ?></strong> (Grade <?= $grade ?>)</span>
    </div>
  </header>
